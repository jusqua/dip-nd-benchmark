function benchmark(inputPattern, startIndex, endIndex, numRounds, outputFolder, varargin)
    ...
    builder.attach('upload', ...
        @() gpuArray(single(reshapedData)), ...
        @(name) wait(gpuDev));

    builder.attach('download', ...
    ...
    builder.attach('split-erode-cube', ...
